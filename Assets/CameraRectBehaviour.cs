...
/// <summary>
/// This script changes the camera's viewport in order to preserve 
/// the original aspect ratio. Be sure to change the canvas render mode to
/// "Screen Space - Camera" so the UI displays correctly as the camera's view changes.
/// Once you change the option, it should ask for a "Render Camera". You can make this
/// your game's main camera.
/// </summary>
public class CameraRectBehaviour : MonoBehaviour
{
